        ...
        <div className=" md:mx-0 md:w-auto w-[366px] mx-auto max-w-full">
          ...
          <div id="posts" className="width">
            ...
            >
              ...
              >
                <div className="flex md:flex-row flex-col md:w-auto min-w-[366px] max-w-full">
                  <div
                    className={`lg:basis-[643px] md:basis-[453px] bg-cover md:h-full lg:min-h-[362px] md:min-h-[255px] sm:min-h-auto bg-center md:rounded-l-2xl  md:rounded-tr-none  rounded-t-lg transition hover:after:scale-110 w-full h-full min-h-[200px]`}
                    style={{
            ...
            <div className="flex md:flex-row flex-col lg:gap-x-9 md:gap-x-6 flex-wrap  max-w-full">
              {tops.map((post) => (
                <div key={post.title} className="lg:mt-9 mt-6">
                  <button
                    onClick={() => {
                      router.push(`/${post.id}`);
                    }}
                  ...
                  >
                    <LazyMotion features={domAnimation}>
                      ...
                      >
                        <div
                          className={`bg-cover md:h-full lg:min-h-[266px] md:min-h-[187px] min-h-auto bg-center md:rounded-t-2xl rounded-t-lg transition hover:after:scale-110 w-full h-full min-h-[200px] lg:w-[472px]`}
                          style={{
